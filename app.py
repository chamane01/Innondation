...
def generate_depth_map(ax, grid_Z, grid_X, grid_Y, X_min, X_max, Y_min, Y_max, label_rotation_x=0, label_rotation_y=0):
    ...
    # Ajouter des labels pour les contours
    ax.clabel(contour_lines, inline=True, fmt={seuil_bas_fond: f"{seuil_bas_fond:.2f} m"}, fontsize=12, colors='white', fontweight='bold', path_effects=[plt.patheffects.withStroke(linewidth=2, foreground='black')])
