...
# Ajouter un bouton pour afficher les polygones et la carte de profondeur
if st.button("Afficher les polygones et la carte de profondeur"):
    ...
    # Supposons que `grid_Z`, `grid_X` et `grid_Y` sont déjà définis ou générés ailleurs
    fig, ax = plt.subplots(figsize=(8, 6))

    # Ajouter la carte de profondeur
    generate_depth_map(ax, grid_Z, grid_X, grid_Y, X_min, X_max, Y_min, Y_max)

    # Ajouter les polygones sur la même carte
